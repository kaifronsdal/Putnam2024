...
# Dataset path
DATASET="putnam_2024_b.json"

# GPUs
export CUDA_VISIBLE_DEVICES="0,1,6,7"

# Base command
BASE_CMD="inspect eval eval.py --log-dir logs_2024_b_5_shot -T dataset_path=${DATASET}"
...
$BASE_CMD --model vllm/meta-llama/Llama-3.1-70B-Instruct -M tensor_parallel_size=4

# Llama 7B
echo "Running Llama 7B evaluation..."
$BASE_CMD --model vllm/meta-llama/Llama-3.1-8B-Instruct -M tensor_parallel_size=4

# Qwen 7B Math Instruct
echo "Running QwQ-32B-Preview evaluation..."
$BASE_CMD --model vllm/Qwen/QwQ-32B-Preview -M tensor_parallel_size=4

# Qwen 2.5 Math Instruct
echo "Running Qwen 2.5 Math evaluation..."
$BASE_CMD --model vllm/Qwen/Qwen2.5-Math-72B-Instruct -M tensor_parallel_size=4

# Numina 72B
#echo "Running Numina 72B evaluation..."
$BASE_CMD --model vllm/AI-MO/NuminaMath-72B-CoT -M tensor_parallel_size=4
